...
export class GroupComponent implements OnInit, MatCardModule {
  ...
  categories = [
   ...
   groups = [
    ...
    {"group_id": 6, "name": "MOceanS", "authors": ["Astrid Cornils"], "year": 2015}   ]
